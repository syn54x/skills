...
const implementPrompt = (t) =>
  ...
  `Run \`gh issue view ${t.n}\` and follow the skill /implement-issue ${t.n} exactly: claim, branch sdd/${t.n}-<slug> ` +
...
const reviewPrompt = (r) =>
  `Review PR #${r.pr} against sub-issue #${r.ticket} by following the skill /review-pr ${r.pr}. ` +
